  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg px-4">
      <div className="w-full max-w-sm rounded-2xl border border-border bg-surface p-8">
        ...
        <p className="mt-1 text-sm text-text-muted">Aquest compte és només per accedir a l'app — no és el teu compte de LALIGA Fantasy.</p>
        <form onSubmit={onSubmit} className="mt-6 space-y-4">
          ...
          <div>
            <label className="text-xs font-medium text-text-muted">Confirma la contrasenya</label>
            <input
              type="password"
              required
